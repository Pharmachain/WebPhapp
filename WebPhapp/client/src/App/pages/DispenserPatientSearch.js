...
import DispenserPeople from '../components/DispenserPeople'


class DispenserPatientSearch extends Component {
    ...
    return (
      <div className="col-xl-8 order-xl-1 center">
        <div className="card bg-secondary shadow">
          <div className="card-header bg-white border-0">
            <div className="row align-items-center">
              <div className="col-8 text-left">
                <h3 className="mb-0">Dispenser: Patient Search</h3>
              </div>
            </div>
          </div>
          ...
          <br></br>
          <DispenserPeople patientList={this.state.people}/>
          </div>
          </div>
        </div>
      </div>
...
export default DispenserPatientSearch;
